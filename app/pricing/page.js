      ...
      <main style={{ background: 'var(--bg)', minHeight: 'calc(100vh - 56px)' }}>
        ...
        <div style={{ background: 'var(--navy)', padding: '56px 28px 48px', textAlign: 'center' }}>
          <div style={{ maxWidth: 640, margin: '0 auto' }}>
            <div style={{ display: 'inline-block', background: 'rgba(201,168,76,0.15)', border: '1px solid rgba(201,168,76,0.3)', borderRadius: 20, padding: '4px 14px', fontSize: 12, color: '#C9A84C', marginBottom: 16, fontWeight: 500 }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '48px 28px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, alignItems: 'start' }}>
            {plans.map(plan => (
              <div key={plan.name} style={{
                ...
                overflow: 'hidden',
                position: 'relative',
                boxShadow: plan.highlight ? '0 8px 24px rgba(201,168,76,0.12)' : '0 1px 3px rgba(0,0,0,0.06)',
              }}>
                {plan.badge && (
          ...
          <div style={{ marginTop: 56, background: 'var(--navy)', borderRadius: 16, padding: '40px', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/login?signup=1" style={{ background: '#C9A84C', color: '#0D1B3E', padding: '12px 28px', borderRadius: 8, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>
                Start free →
              </Link>
              <Link href="/login?signup=1&type=team" style={{ background: 'transparent', color: '#C9A84C', border: '1px solid rgba(201,168,76,0.4)', padding: '12px 28px', borderRadius: 8, fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>
                Start team trial →
              </Link>
            </div>
          </div>
